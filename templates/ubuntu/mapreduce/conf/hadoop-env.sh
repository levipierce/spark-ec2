...
# NOTE: Set this to /home/ubuntu/mapreduce so that start-mapred.sh works correctly
export HADOOP_HOME="/home/ubuntu/mapreduce"
export HADOOP_MAPREDUCE_HOME="/home/ubuntu/mapreduce"
...
# Set hadoop user for CDH (which doesn't allow running as home/ubuntu)
